...
-- Paid bookings that could not be materialized while MySQL was down.
...
-- Public-site CMS overlay (empty JSON = 100% code defaults).
...
-- Uploaded media library (counts toward the 150 MB quota; /public files do not).
